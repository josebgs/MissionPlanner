...
{
    public partial class ConfigPlannerPilot : MyUserControl, IActivate
    {
        private List<CultureInfo> _languages;
        private bool startup;
        static temp temp;

        public ConfigPlannerPilot()
        {
            InitializeComponent();
            ...
            CMB_videosources.Visible = false;
            BUT_videostart.Visible = false;
            BUT_videostop.Visible = false;
            CHK_hudshow.Visible = false;
            label26.Visible = false;
            CMB_videoresolutions.Visible = false;
            label94.Visible = false;
            CMB_osdcolor.Visible = false;
            label95.Visible = false;
            CHK_enablespeech.Visible = false;
            ...
            CMB_language.Visible = false;
            label96.Visible = false;
            BUT_Joystick.Visible = false;
        ...
        private void ConfigPlannerPilot_Load(object sender, EventArgs e)
        {
        }
